...
If you would like to make this project using Python instead of Scratch, head on over to the [Python worksheet](https://projects.raspberrypi.org/en/projects/scary-spot-the-difference).
